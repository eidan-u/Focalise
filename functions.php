 ...
 */
 function focalise_css_assets(){
	wp_register_style('perso', get_template_directory_uri() . '/css/focalise.css');
	wp_enqueue_style('perso');
}
add_action('wp_enqueue_scripts', 'focalise_css_assets'); // Charge mon css perso
